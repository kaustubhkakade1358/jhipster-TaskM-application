...
class TaskResourceIT {
    ...
    void putExistingTask() throws Exception {
        ...
        updatedTask.title(UPDATED_TITLE).description(UPDATED_DESCRIPTION).startTime(UPDATED_START_TIME).endTime(UPDATED_END_TIME);
    ...
    void partialUpdateTaskWithPatch() throws Exception {
        ...
        partialUpdatedTask.description(UPDATED_DESCRIPTION).endTime(UPDATED_END_TIME);
    ...
    void fullUpdateTaskWithPatch() throws Exception {
        ...
        partialUpdatedTask.title(UPDATED_TITLE).description(UPDATED_DESCRIPTION).startTime(UPDATED_START_TIME).endTime(UPDATED_END_TIME);
