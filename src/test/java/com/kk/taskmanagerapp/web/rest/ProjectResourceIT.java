...
class ProjectResourceIT {
    ...
    public static Project createEntity(EntityManager em) {
        Project project = new Project().projectName(DEFAULT_PROJECT_NAME).startDate(DEFAULT_START_DATE).endDate(DEFAULT_END_DATE);
        return project;
    }
    ...
    public static Project createUpdatedEntity(EntityManager em) {
        Project project = new Project().projectName(UPDATED_PROJECT_NAME).startDate(UPDATED_START_DATE).endDate(UPDATED_END_DATE);
        return project;
    }
    ...
    void putExistingProject() throws Exception {
        ...
        updatedProject.projectName(UPDATED_PROJECT_NAME).startDate(UPDATED_START_DATE).endDate(UPDATED_END_DATE);
    ...
    void fullUpdateProjectWithPatch() throws Exception {
        ...
        partialUpdatedProject.projectName(UPDATED_PROJECT_NAME).startDate(UPDATED_START_DATE).endDate(UPDATED_END_DATE);
