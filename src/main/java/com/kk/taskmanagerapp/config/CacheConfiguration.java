package com.kk.taskmanagerapp.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, com.kk.taskmanagerapp.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, com.kk.taskmanagerapp.repository.UserRepository.USERS_BY_EMAIL_CACHE);
